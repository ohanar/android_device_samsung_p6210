...
adb pull /system/lib/libsecril-apalone.so ../../../vendor/$MANUFACTURER/$DEVICE/proprietary/libsecril-apalone.so
...
PRODUCT_COPY_FILES += \\
    ...
    vendor/__MANUFACTURER__/__DEVICE__/proprietary/libsecril-apalone.so:system/lib/libsecril-apalone.so \\
